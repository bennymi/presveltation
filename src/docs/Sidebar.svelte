...
<nav
	class="h-full space-y-4 overflow-y-auto border-r-2 border-purple-600/50 px-8 pt-6 pb-8 text-sm backdrop-blur-sm dark:border-purple-600/30 dark:bg-gray-900/30 dark:text-gray-300"
>
